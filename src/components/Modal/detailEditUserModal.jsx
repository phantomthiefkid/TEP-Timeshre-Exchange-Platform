        ...
        <div className="p-6 text-left space-y-4">
          ...
          <div className="mt-8 p-6 text-left space-y-8">
            ...
            <div className="flex items-center gap-4">
              <label className="block text-gray-600 font-medium w-1/3">
                Tên đăng nhập
              </label>
              <input
                type="text"
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative w-full">
                <select
                  className={`px-4 py-2 rounded-lg text-gray-500 border bg-gray-200 focus:ring focus:ring-blue-500 focus:outline-none transition-all ease-in-out duration-300 w-full ${
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center">
                <label className="flex items-center">
                  ...
                  >
                    <div
                      className={`absolute top-0.5 left-0.5 h-5 w-5 bg-white border-gray-300 border rounded-full transition-transform duration-300 ${
