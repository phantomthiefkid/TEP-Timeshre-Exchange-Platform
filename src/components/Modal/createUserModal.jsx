    ...
    return (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center">
            <div className="bg-white rounded-lg p-6 w-full max-w-md">
                ...
                <h2 className="text-2xl  font-semibold text-gray-700 mb-4">Tạo mới tài khoản</h2>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4 relative">
                        ...
                        >
                            {showPassword ? <EyeIcon className='w-5' color='black'/> : <EyeOffIcon className='w-5' color='black'/>} {/* Change button label */}
                        </button>
                    </div>

                    {/* Role */}
                    <div className="mb-4">
                        <label className="block text-gray-700 font-medium mb-2">Vài trò</label>
                        <select
                            value={roleId}
