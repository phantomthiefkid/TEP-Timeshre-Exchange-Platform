...
import { FaRegFile, FaSave, FaTimes } from 'react-icons/fa';


const AddPolicyModal = ({ isOpen, onClose, onUpdate }) => {
            ...
            <div className="bg-white rounded-lg shadow-lg w-2/5">
                ...
                <form className="p-6 space-y-4" onSubmit={handleSubmit}>
                    <div>
                        ...
                        />
                        {errors.title && (
                            <p className="text-sm text-red-500 mt-1">Chính sách không được để trống.</p>
                        )}
                    </div>
                    <div>
                        ...
                        ></textarea>
                        {errors.description && (
                            <p className="text-sm text-red-500 mt-1">Nội dung không được để trống.</p>
                        )}
                    </div>
