...
import { FaQuestionCircle, FaSave, FaTimes } from "react-icons/fa";

const UpdateFaqModal = ({ isOpen, onClose, selected, onUpdate }) => {
    ...
    const handleSubmit = (e) => {
        ...
        const updatedFaq = {
            faqId: selected.faqId,  // assuming `selected` has an `id` property
            title,
            description,
            type: "general"
        };
                ...
                <form className="p-6 space-y-4" onSubmit={handleSubmit}>
                    <div>
                        <label className="text-sm font-medium text-gray-700 flex items-center">
                            <FaQuestionCircle className="mr-2 text-gray-500" /> Câu hỏi
                        </label>
                        <input
                            type="text"
                            name="title"
