            ...
            <div className='lg:px-14 md:px-14 py-10 w-3/4 mx-auto'>
                ...
                <div className='py-16 text-indigo-600'>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 py-8">
                        {resort && resort.feedbackList && resort.feedbackList.slice(0, visibleFeedbackCount).map((item, index) => (
                            <div key={index} className="border-b-4 w-full p-6 flex justify-between bg-gray-50 rounded-lg shadow-md">
                                <div className="flex flex-col justify-start gap-6 w-2/3">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                <p className="text-md text-gray-600">Người đánh giá: {item.user && item.user.fullName}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="py-4 p-4">
                                        <p className="text-lg font-semibold">Nội dung đánh giá: <span className="text-md font-normal">{item.comment}</span></p>
                                    </div>
                                </div>
                                <div className="w-1/3 text-left">
                                    <span className="font-medium text-lg text-gray-800">Đánh giá</span>
                                    <div className="flex justify-start items-center gap-2">
                                        {Array.from({ length: item.ratingPoint }, (_, index) => (
                                            <StarIcon key={index} className="w-8 text-yellow-500" />
                                        ))}
                                    </div>
                                </div>
                            </div>
                        ...
                        {resort && resort.feedbackList && visibleFeedbackCount < resort.feedbackList.length && (
