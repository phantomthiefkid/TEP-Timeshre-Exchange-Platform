      ...
      <div className="container mx-auto p-4 bg-white rounded-xl shadow-xl">
        <div className="py-4 p-6 space-y-4 border-l-4 border-blue-500 bg-gray-50 rounded-lg shadow-lg">
          ...
          <h3 className="text-lg text-gray-500">
            ...
            các mục đang chờ định giá và
            <span className="font-semibold text-blue-600">
              {" "}
              theo dõi tiến trình phê duyệt giá cả
            </span>{" "}
            tại đây.
          </h3>
        </div>
        ...
        <div className="min-h-[700px] relative">
                  ...
                  >
                    <td className="p-4 flex items-center w-72">
                      ...
                      <div className="flex flex-col">
                        <h3 className="font-base">{posting.resortName}</h3>
                      </div>
                    </td>
          ...
          {rentalPostings && rentalPostings.length > 0 ? (
            <div className="flex items-center justify-center space-x-2 mt-5 w-full absolute bottom-4 z-0">
              <button
            ...
            <div className="flex flex-col items-center justify-center mt-5 w-full min-h-[600px] border-2 border-dashed border-gray-300 rounded-lg bg-gradient-to-b from-gray-50 to-gray-100">
