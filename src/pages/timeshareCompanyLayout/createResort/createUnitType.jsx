      ...
      <div className=" p-6 ">
        <div className="py-6 space-y-3">
          <h1 className="text-2xl font-semibold text-gray-600">
            Quản lý và tạo mới các loại phòng với thông tin chi tiết để phục vụ
            nhu cầu khách hàng
          </h1>
          <h3 className="text-lg text-gray-600">
            Cung cấp các loại phòng với thông tin tiện nghi cụ thể và quản lý
            chi tiết để nâng cao trải nghiệm người dùng
          </h3>
        </div>
              ...
              <div className="w-1/3 h-full overflow-hidden">
                <img
                  src={
                    room.photos
                      ? room.photos
                      : "https://unwinds.s3.ap-southeast-2.amazonaws.com/1733452558997_1.webp"
                  }
                  alt={room.title}
