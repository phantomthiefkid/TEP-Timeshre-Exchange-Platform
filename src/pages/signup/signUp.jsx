      ...
      <div className='relative col-span-1 flex justify-center items-center p-6 lg:p-12'>
        ...
        <div className='w-full max-w-md relative z-10'>
            ...
            <div className='relative'>
              ...
              <div className='absolute inset-y-0 top-6 left-0 pl-3 flex items-center pointer-events-none'>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 14c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-3.87 0-7 3.13-7 7v1h14v-1c0-3.87-3.13-7-7-7z" />
                </svg>
              </div>
              <input
                type='text'
          ...
          <div className='mt-6 text-center text-md'>
            ...
            <a href='/signin' className='ml-1 text-blue-500 hover:text-blue-800 font-medium'>
              Quay lại đăng nhập
            </a>
          </div>
        </div>
